 ...
 * <ul>
 *   <li>{@link org.skinsoft.nuxeo.components.lifecycle.impl.TransitionsTypeImpl#getTransition <em>Transition</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TransitionsTypeImpl extends EObjectImpl implements TransitionsType {
	...
	protected EClass eStaticClass() {
		return LifecyclePackage.Literals.TRANSITIONS_TYPE;
	}
	...
	public EList<TransitionType> getTransition() {
		if (transition == null) {
			transition = new EObjectContainmentEList<TransitionType>(TransitionType.class, this, LifecyclePackage.TRANSITIONS_TYPE__TRANSITION);
		}
		return transition;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case LifecyclePackage.TRANSITIONS_TYPE__TRANSITION:
