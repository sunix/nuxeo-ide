...
public class SearchAdapterFactory extends AdapterFactoryImpl {
	...
	protected SearchSwitch<Adapter> modelSwitch =
		new SearchSwitch<Adapter>() {
			...
			@Override
			public Adapter caseIndexableDocTypeType(IndexableDocTypeType object) {
				return createIndexableDocTypeTypeAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.skinsoft.nuxeo.components.search.ComponentType <em>Component Type</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.skinsoft.nuxeo.components.search.DocumentRoot <em>Document Root</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.skinsoft.nuxeo.components.search.ExtensionType <em>Extension Type</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.skinsoft.nuxeo.components.search.IndexableDocTypeType <em>Indexable Doc Type Type</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createIndexableDocTypeTypeAdapter() {
		return null;
	}
