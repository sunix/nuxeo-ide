 ...
 * @generated
 */
public class CoretypesSwitch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case CoretypesPackage.COMPONENT_TYPE: {
				ComponentType componentType = (ComponentType)theEObject;
				T result = caseComponentType(componentType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CoretypesPackage.DOCTYPE_TYPE: {
				DoctypeType doctypeType = (DoctypeType)theEObject;
				T result = caseDoctypeType(doctypeType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CoretypesPackage.DOCUMENT_ROOT: {
				DocumentRoot documentRoot = (DocumentRoot)theEObject;
				T result = caseDocumentRoot(documentRoot);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CoretypesPackage.EXTENSION_TYPE: {
				ExtensionType extensionType = (ExtensionType)theEObject;
				T result = caseExtensionType(extensionType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CoretypesPackage.FACET_TYPE: {
				FacetType facetType = (FacetType)theEObject;
				T result = caseFacetType(facetType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CoretypesPackage.SCHEMA_TYPE: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Doctype Type</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Doctype Type</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseDoctypeType(DoctypeType object) {
		return null;
	}
