 ...
 * $Id$
 */
package org.skinsoft.nuxeo.components.field.to.directory.association.util;
...
public class AssociationAdapterFactory extends AdapterFactoryImpl {
	...
	protected AssociationSwitch<Adapter> modelSwitch =
		new AssociationSwitch<Adapter>() {
			@Override
			public Adapter caseAssociateType(AssociateType object) {
				return createAssociateTypeAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.skinsoft.nuxeo.components.field.to.directory.association.AssociateType <em>Associate Type</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createAssociateTypeAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link org.skinsoft.nuxeo.components.field.to.directory.association.ComponentType <em>Component Type</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.skinsoft.nuxeo.components.field.to.directory.association.DocumentRoot <em>Document Root</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.skinsoft.nuxeo.components.field.to.directory.association.ExtensionType <em>Extension Type</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
