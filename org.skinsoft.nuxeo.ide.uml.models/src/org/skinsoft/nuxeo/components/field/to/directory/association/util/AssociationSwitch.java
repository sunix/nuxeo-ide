 ...
 * @generated
 */
public class AssociationSwitch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case AssociationPackage.ASSOCIATE_TYPE: {
				AssociateType associateType = (AssociateType)theEObject;
				T result = caseAssociateType(associateType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AssociationPackage.COMPONENT_TYPE: {
			...
			case AssociationPackage.EXTENSION_TYPE: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Associate Type</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Associate Type</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseAssociateType(AssociateType object) {
		return null;
	}
