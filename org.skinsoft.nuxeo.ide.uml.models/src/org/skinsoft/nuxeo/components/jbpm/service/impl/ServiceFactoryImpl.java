...
public class ServiceFactoryImpl extends EFactoryImpl implements ServiceFactory {
	...
	public static ServiceFactory init() {
		try {
			ServiceFactory theServiceFactory = (ServiceFactory)EPackage.Registry.INSTANCE.getEFactory("http://skinsoft.org/nuxeo/components/jbpmService"); 
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case ServicePackage.COMPONENT_TYPE: return createComponentType();
			case ServicePackage.DOCUMENT_ROOT: return createDocumentRoot();
			case ServicePackage.EXTENSION_TYPE: return createExtensionType();
			case ServicePackage.PROCESS_DEFINITION_TYPE: return createProcessDefinitionType();
			case ServicePackage.SECURITY_POLICY_TYPE: return createSecurityPolicyType();
			case ServicePackage.TYPE_TYPE: return createTypeType();
			default:
	...
	public SecurityPolicyType createSecurityPolicyType() {
		SecurityPolicyTypeImpl securityPolicyType = new SecurityPolicyTypeImpl();
