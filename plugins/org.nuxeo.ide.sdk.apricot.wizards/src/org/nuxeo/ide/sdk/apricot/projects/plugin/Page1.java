 ...
 *     bstefanescu
 */
package org.nuxeo.ide.sdk.apricot.projects.plugin;
 ...
 * 
 */
public class Page1 extends FormWizardPage<ProjectTemplateContext> implements
        Constants {

    public final static String PROJECT_LOCATION = "projectLocation";

    public Page1(String id, String title, ImageDescriptor image) {
        super(id, title, image);
    }

    public Page1() {
        super("apricotProjectPage1", "Create an Apricot Plugin", null);
    }
            ...
            public void keyReleased(org.eclipse.swt.events.KeyEvent e) {
                ...
                if (text.length() > 0) {
                    if (ImportProject.isExistingProject(text)) {
                        Page1.this.setErrorMessage("A project with that name already exists");
