        ...
        actionBars.setGlobalActionHandler(ICommonActionConstants.OPEN,
                new Action() {
                    ...
                    public void run() {
                        ...
                        StudioProject project = (StudioProject) selection.getFirstElement();
                        IEditorInput input = new StudioEditorInput(project);
                        try {
                            PlatformUI.getWorkbench().getActiveWorkbenchWindow().getActivePage().openEditor(
                                    input, StudioEditor.ID);
                        } catch (Exception e) {
                            UI.showError("Failed to open Studio Project: "
                                    + project.getId(), e);
                        }
                    }
                });
