...
public class Util {
    ...
    public static File getManifest(File dir) {
        return new File(dir, "src/main/resources/META-INF/MANIFEST.MF");
    }

    public static File getExtensions(File dir) {
        return new File(dir, "src/main/resources/OSGI-INF/extensions.xml");
    }

    public static File getPom(File dir) {
