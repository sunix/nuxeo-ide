...
import org.nuxeo.ide.common.forms.widgets.DirectoryChooser;
...
public class DirectoryChooserWidget extends UIValueObject<DirectoryChooser>
        implements HasValue {

    @Override
    protected DirectoryChooser createControl(Composite parent, Element element,
            BindingContext ctx) {
