 ...
 *
 */
public class PermissionWizardPage extends FeatureWizardPage {

    public PermissionWizardPage() {
        super("permission1", "Create Permission", null);
    }
    ...
    public void update(FeatureTemplateContext ctx) {
        ...
        DynamicTable table = (DynamicTable) form.getWidgetControl("selectedPermission");
        ctx.put("selectedPermission", table.getSelectedValues());
    }
